...
BEGIN
    ...
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise1Id, 'crawlA1', 'arguments are nothing but stupid', 10, TRUE) RETURNING argID INTO argument1Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise2Id, 'crawlA2', 'arguments are nothing but boring', 20, FALSE) RETURNING argID INTO argument2Id;

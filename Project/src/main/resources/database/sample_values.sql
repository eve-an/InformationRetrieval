...
BEGIN
    ...
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise1Id, 'crawlA1', 'some Content 1', 10, TRUE) RETURNING argID INTO argument1Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise2Id, 'crawlA2', 'some Content 2', 20, FALSE) RETURNING argID INTO argument2Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise3Id, 'crawlA3', 'some Content 3', 30, TRUE) RETURNING argID INTO argument3Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise4Id, 'crawlA4', 'some Content 4', 40, FALSE) RETURNING argID INTO argument4Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise5Id, 'crawlA5', 'some Content 5', 50, TRUE) RETURNING argID INTO argument5Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise6Id, 'crawlA6', 'some Content 6', 60, FALSE) RETURNING argID INTO argument6Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise7Id, 'crawlA7', 'some Content 7', 70, TRUE) RETURNING argID INTO argument7Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise8Id, 'crawlA8', 'some Content 8', 80, FALSE) RETURNING argID INTO argument8Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise9Id, 'crawlA9', 'some Content 9', 90, TRUE) RETURNING argID INTO argument9Id;
    INSERT INTO argument(pID, crawlID, content, totalTokens, isPro) VALUES (premise10Id, 'crawlA10', 'some Content 10', 100, FALSE) RETURNING argID INTO argument10Id;

    INSERT INTO arg_index VALUES (helloTokenId, argument1Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (helloTokenId, argument2Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (helloTokenId, argument3Id, 0, 2, '{1, 4}');
    INSERT INTO arg_index VALUES (helloTokenId, argument4Id, 0, 5, '{1, 4}');
    INSERT INTO arg_index VALUES (helloTokenId, argument6Id, 0, 3, '{1, 2, 4}');
    INSERT INTO arg_index VALUES (helloTokenId, argument7Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (helloTokenId, argument10Id, 0, 3, '{0, 5, 6}');

    INSERT INTO arg_index VALUES (thisTokenId, argument1Id, 0, 2, '{0, 2}');
    INSERT INTO arg_index VALUES (thisTokenId, argument2Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (thisTokenId, argument3Id, 0, 3, '{0, 2, 4}');
    INSERT INTO arg_index VALUES (thisTokenId, argument4Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (thisTokenId, argument5Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (thisTokenId, argument6Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (thisTokenId, argument7Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (thisTokenId, argument8Id, 0, 3, '{1, 2, 7}');

    INSERT INTO arg_index VALUES (isTokenId, argument1Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (isTokenId, argument2Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (isTokenId, argument3Id, 0, 2, '{0, 2}');
    INSERT INTO arg_index VALUES (isTokenId, argument4Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (isTokenId, argument5Id, 0, 3, '{0, 2, 4}');
    INSERT INTO arg_index VALUES (isTokenId, argument6Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (isTokenId, argument8Id, 0, 3, '{0, 3, 7}');
    INSERT INTO arg_index VALUES (isTokenId, argument9Id, 0, 2, '{1, 2}');

    INSERT INTO arg_index VALUES (aTokenId, argument1Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (aTokenId, argument2Id, 0, 3, '{1, 2, 4}');
    INSERT INTO arg_index VALUES (aTokenId, argument7Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (aTokenId, argument8Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (aTokenId, argument9Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (aTokenId, argument10Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (aTokenId, argument3Id, 0, 3, '{1, 2, 7}');

    INSERT INTO arg_index VALUES (testTokenId, argument3Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (testTokenId, argument4Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (testTokenId, argument5Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (testTokenId, argument6Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (testTokenId, argument7Id, 0, 2, '{1, 4}');
    INSERT INTO arg_index VALUES (testTokenId, argument8Id, 0, 5, '{1, 5}');
    INSERT INTO arg_index VALUES (testTokenId, argument9Id, 0, 3, '{1, 2, 4}');

    INSERT INTO arg_index VALUES (worldTokenId, argument3Id, 0, 5, '{1, 2}');
    INSERT INTO arg_index VALUES (worldTokenId, argument4Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (worldTokenId, argument5Id, 0, 2, '{1, 2}');
    INSERT INTO arg_index VALUES (worldTokenId, argument6Id, 0, 3, '{0, 3, 5}');
    INSERT INTO arg_index VALUES (worldTokenId, argument7Id, 0, 2, '{1, 4}');
    INSERT INTO arg_index VALUES (worldTokenId, argument8Id, 0, 5, '{1, 5}');
    INSERT INTO arg_index VALUES (worldTokenId, argument9Id, 0, 3, '{1, 2, 4}');
    ----
